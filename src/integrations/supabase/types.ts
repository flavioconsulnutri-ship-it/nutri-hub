  ...
  public: {
    Tables: {
      ...
      crm_action_catalog: {
        ...
        Relationships: [
          {
            foreignKeyName: "crm_action_catalog_org_id_fkey";
            columns: ["org_id"];
            isOneToOne: false;
            referencedRelation: "organizations";
            referencedColumns: ["id"];
    ...
    Enums: {
      ...
      app_role: "admin" | "nutricionista" | "atendimento" | "financeiro" | "estagiario";
      appointment_mode: "presencial" | "online";
      appointment_status:
        "agendada" | "confirmada" | "realizada" | "remarcada" | "cancelada" | "falta";
